        ...
        def solve_recursive():
            if movements:
                ...
                if(movement[0] in 'XYZ'):
                    if(movement[0] == 'X'):
                        if(movement[-1] == 'i'):
                            self.rotate_side_2('Li')
                            self.rotate_side_2('Mi')
                            self.rotate_side_2('Ri')
                        else:
                            self.rotate_side('L')
                            self.rotate_side('M')
                            self.rotate_side('R')
                        ...
                        if(movement[-1] == 'i'):
                            self.rotate_side_2('Ui')
                            self.rotate_side_2('Ei')
                            self.rotate_side_2('Di')
                        else:
                            self.rotate_side('U')
                            self.rotate_side('E')
                            self.rotate_side('D')
                        ...
                        if(movement[-1] == 'i'):
                            self.rotate_side_2('Bi')
                            self.rotate_side_2('Si')
                            self.rotate_side_2('Fi')
                        else:
                            self.rotate_side('B')
                            self.rotate_side('S')
                            self.rotate_side('F')
